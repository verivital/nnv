...
def main(mat_file_path: str):
    ...
    # Load MATLAB data
    mat_data = scipy.io.loadmat(mat_file_path + '/Reduced_dimension.mat')
    ...
    save_path = mat_file_path + "/trained_Linear_weights_norm.mat";
