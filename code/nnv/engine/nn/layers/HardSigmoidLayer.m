...
%     methods(Static)
%          % parse a trained hard simoid layer from matlab (TODO)
%         function L = parse(layer)
%               There is a possibility that we need to create a similar layer to this called 
%               nnet.onnx.layers.clippedReluLayer, but that has variable
%               ceiling and 1-to-1 slope, whereas hard sigmoid is slightly
%               different.
%         end
%         
%     end
