classdef LayerS
    ...
    methods % reachability analysis method
        ...
        function S = reach(varargin)
            ...
            if ~strcmp(method, 'exact-star') && ~strcmp(method, 'approx-star') && ~strcmp(method, 'approx-star-fast') && ~contains(method, 'relax-star') && ~strcmp(method, 'approx-zono') && ~strcmp(method, 'abs-dom') && ~strcmp(method, 'exact-polyhedron') && ~strcmp(method, 'approx-star-split') && ~strcmp(method,'approx-star-no-split') && ~strcmp(method, 'approx-rstar-0') && ~strcmp(method, 'approx-rstar-2') && ~strcmp(method, 'approx-rstar-4')
