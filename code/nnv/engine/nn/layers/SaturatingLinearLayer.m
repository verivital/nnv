classdef SaturatingLinearLayer < handle
    % The SaturationLinearLayer class in CNN
    ...
    methods
        ...
        function obj = SaturationLinearLayer(varargin)           
            % author: Diego Manzanas
            % date: 12/06/2022   
            
            switch nargin
                
                case 5 % used for parsin a matlab layer
                    obj.Name = varargin{1};
