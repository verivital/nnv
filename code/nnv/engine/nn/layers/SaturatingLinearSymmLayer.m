classdef SaturatingLinearSymmLayer < ActivationFunctionLayer
    % The Symmetric saturating linear transfer function in NN
    ...
    methods
        ...
        function obj = SaturatingLinearSymmLayer(varargin)           
