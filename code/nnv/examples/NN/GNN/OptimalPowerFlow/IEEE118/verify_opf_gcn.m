% verify_opf_gcn.m - GCN Optimal Power Flow Verification Example (IEEE 118-bus)
%
% This example demonstrates GNN verification for Optimal Power Flow prediction
% using a 3-layer GCN model on the IEEE 118-bus system.
%
% The script performs:
...
modelPath = fullfile(fileparts(mfilename('fullpath')), 'models', 'gcn_opf_ieee118_run3_seed130.mat');
model = load(modelPath);

fprintf('=== GCN Optimal Power Flow Verification (IEEE 118-bus) ===\n');
fprintf('Model: %s\n\n', modelPath);
