% verify_opf_gine.m - GINE Optimal Power Flow Verification Example (IEEE 118-bus)
%
% This example demonstrates GNN verification for Optimal Power Flow prediction
% using a 3-layer GINE model on the IEEE 118-bus system.
%
% The script performs:
...
modelPath = fullfile(fileparts(mfilename('fullpath')), 'models', 'gine_edgelist_opf_ieee118_run5_seed132.mat');
model = load(modelPath);

fprintf('=== GINE Optimal Power Flow Verification (IEEE 118-bus) ===\n');
fprintf('Model: %s\n\n', modelPath);
