% verify_opf_gcn.m - GCN Optimal Power Flow Verification Example (IEEE 24-bus)
%
% This example demonstrates GNN verification for Optimal Power Flow prediction
% using a 3-layer GCN model on the IEEE 24-bus system.
%
% The script performs:
...
modelPath = fullfile(fileparts(mfilename('fullpath')), 'models', 'gcn_opf_ieee24_run5_seed132.mat');
model = load(modelPath);

fprintf('=== GCN Optimal Power Flow Verification (IEEE 24-bus) ===\n');
fprintf('Model: %s\n\n', modelPath);
