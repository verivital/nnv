% verify_opf_gine.m - GINE Optimal Power Flow Verification Example (IEEE 39-bus)
%
% This example demonstrates GNN verification for Optimal Power Flow prediction
% using a 3-layer GINE model on the IEEE 39-bus (New England) system.
%
% The script performs:
...
modelPath = fullfile(fileparts(mfilename('fullpath')), 'models', 'gine_edgelist_opf_ieee39_run2_seed129.mat');
model = load(modelPath);

fprintf('=== GINE Optimal Power Flow Verification (IEEE 39-bus) ===\n');
fprintf('Model: %s\n\n', modelPath);
