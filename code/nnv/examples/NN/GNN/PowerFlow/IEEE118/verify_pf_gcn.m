% verify_pf_gcn.m - GCN Power Flow Verification Example (IEEE 118-bus)
%
...
modelPath = fullfile(fileparts(mfilename('fullpath')), 'models', 'gcn_pf_ieee118_run3_seed130.mat');
model = load(modelPath);

fprintf('=== GCN Power Flow Verification (IEEE 118-bus) ===\n');
fprintf('Model: %s\n\n', modelPath);
