% verify_pf_gine_edge_perturb.m - GINE Power Flow Verification with Edge Perturbation (IEEE 118-bus)
%
% This example demonstrates GNN verification for Power Flow prediction
% using a 3-layer GINE model on the IEEE 118-bus system with BOTH node
% and edge feature perturbations.
%
% The script performs:
...
fprintf('=== GINE Power Flow Verification with Edge Perturbation (IEEE 118-bus) ===\n');
fprintf('Model: %s\n\n', modelPath);
...
fprintf('\n=== Computing Reachability (Node + Edge Perturbation, timeout: %d sec) ===\n', timeoutSeconds);
...
if timedOut
    ...
    fprintf('\n=== Complete (TIMEOUT - Edge Perturbation Mode) ===\n');
else
