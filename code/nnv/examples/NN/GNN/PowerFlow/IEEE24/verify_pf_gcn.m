% verify_pf_gcn.m - GCN Power Flow Verification Example (IEEE 24-bus)
%
...
modelPath = fullfile(fileparts(mfilename('fullpath')), 'models', 'gcn_pf_ieee24_run4_seed131.mat');
model = load(modelPath);

fprintf('=== GCN Power Flow Verification (IEEE 24-bus) ===\n');
fprintf('Model: %s\n\n', modelPath);
