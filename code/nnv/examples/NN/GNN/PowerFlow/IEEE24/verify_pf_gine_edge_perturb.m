% verify_pf_gine_edge_perturb.m - GINE Power Flow Verification with Edge Perturbation (IEEE 24-bus)
%
% This example demonstrates GNN verification for Power Flow prediction
% using a 3-layer GINE model on the IEEE 24-bus system with BOTH node
...
fprintf('=== GINE Power Flow Verification with Edge Perturbation (IEEE 24-bus) ===\n');
fprintf('Model: %s\n\n', modelPath);
