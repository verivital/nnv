% verify_pf_gine.m - GINE Power Flow Verification Example (IEEE 39-bus)
%
...
modelPath = fullfile(fileparts(mfilename('fullpath')), 'models', 'gine_pf_ieee39.mat');
model = load(modelPath);

fprintf('=== GINE Power Flow Verification (IEEE 39-bus) ===\n');
fprintf('Model: %s\n\n', modelPath);
