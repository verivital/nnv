function reach_random_neuralode_M()

    % Create a random example of a Neural ODE and do reachability computation
    t = tic;
    % Set random seed
    rng(0);
    
    % Create random weight variables with following dimensions
    states = 4;
    input = 2;
    output = 2;
    h = 8;
