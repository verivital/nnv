function t = reachVCAS_middle19()
    ...
    % Save results
    if is_codeocean
        save('/results/logs/VCAS_middle19.mat', 'reachAll','t','-v7.3');
    else
        save('VCAS_middle19.mat', 'reachAll','t','-v7.3');
    end
    ...
    % Save figure
    if is_codeocean
        exportgraphics(f,'/results/logs/VCAS_middle19.pdf', 'ContentType', 'vector');
    else
        exportgraphics(f,'VCAS_middle19.pdf','ContentType', 'vector');
    end
    ...
    for l=1:length(r)
        ...
        elseif r(l) == 5
            if m(2) > 25 && (M(4) == 5 || m(4) == 5)
                ...
                y = [y Star([5;
                    accs.CL1500(idx)],[5;accs.CL1500(idx)])];
            end
        elseif r(l) == 6
