function t = reachVCAS_worst19()    
    ...
    % Save results
    if is_codeocean
        save('/results/logs/VCAS_worst19.mat', 'reachAll','t','-v7.3');
    else
        save('VCAS_worst19.mat', 'reachAll','t','-v7.3');
    end
    ...
    % Save figure
    if is_codeocean
        exportgraphics(f,'/results/logs/VCAS_worst19.pdf', 'ContentType', 'vector');
    else
        exportgraphics(f,'VCAS_worst19.pdf','ContentType', 'vector');
    end
