function t = reachVCAS_middle22()    
    ...
    % Save results
    if is_codeocean
        save('/results/logs/VCAS_middle22.mat', 'reachAll','t','-v7.3');
    else
        save('VCAS_middle22.mat', 'reachAll','t','-v7.3');
    end
    ...
    % Save figure
    if is_codeocean
        exportgraphics(f,'/results/logs/VCAS_middle22.pdf', 'ContentType', 'vector');
    else
        exportgraphics(f,'VCAS_middle22.pdf','ContentType', 'vector');
    end
