function t = reachVCAS_middle25()    
    ...
    % Save results
    if is_codeocean
        save('/results/logs/VCAS_middle25.mat', 'reachAll','t','-v7.3');
    else
        save('VCAS_middle25.mat', 'reachAll','t','-v7.3');
    end
    ...
    % Save figure
    if is_codeocean
        exportgraphics(f,'/results/logs/VCAS_middle25.pdf', 'ContentType', 'vector');
    else
        exportgraphics(f,'VCAS_middle25.pdf','ContentType', 'vector');
    end
