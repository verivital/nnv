function compare_mnist_nets_vs_inputsize()
...
save('compare_inputsize.mat', 'avg_RIoU', 'avg_RV', 'avg_RS','avg_numRbPixels', 'avg_numMisPixels',...
...
eexportgraphics(fig, 'compare_mnist_nets_vs_inputsize.pdf', 'ContentType', 'vector');
...
exportgraphics(fig, 'VT_mnist_nets_vs_inputsize.pdf', 'ContentType', 'vector');
