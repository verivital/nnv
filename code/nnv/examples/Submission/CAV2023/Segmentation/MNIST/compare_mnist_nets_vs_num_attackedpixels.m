function compare_mnist_nets_vs_num_attackedpixels()
...
save('compare_num_attack_pixels.mat', 'avg_RIoU', 'avg_RV', 'avg_RS','avg_numRbPixels', 'avg_numMisPixels',...
    'avg_numAttPixels', 'avg_numUnkPixels', 'VT'); 
...
exportgraphics(fig, 'compare_mnist_nets_vs_num_attackedpixels.pdf', 'ContentType', 'vector')
...
exportgraphics(fig2, 'VT_mnist_nets_vs_num_attackedpixels.pdf', 'ContentType', 'vector')
