function example_dilated()
    ...
    for i=1:N1
        ...
        % Save results
        save("dilated_results_"+string(de(i))+".mat", 't', 'riou', 'rs', 'rv')
    end
