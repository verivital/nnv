...
if isempty(S)
    fprintf('\nThe over-approximate star reach set does not reaches the unsafe region, P4 holds on N2_3');
else
    fprintf('\nThe over-approximate star reach set reaches the unsafe region, safety is unknown, P4 may be violated on N2_3');
end
...
S = R.intersectHalfSpace(unsafe_mat, unsafe_vec);
if isempty(S)
    fprintf('\nThe over-approximate zonotope reach set does not reaches the unsafe region, P4 holds on N2_3');
else
    fprintf('\nThe over-approximate zonotope reach set reaches the unsafe region, safety is unknown, P4 may be violated on N2_3');
end
...
if isempty(S)
    fprintf('\nThe over-approximate abstract-domain reach set does not reaches the unsafe region, P4 holds on N2_3');
else
    fprintf('\nThe over-approximate abstract-domain reach set reaches the unsafe region, safety is unknown, P4 may be violated on N2_3');
end
