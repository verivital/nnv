load Reluplex_P3.mat;
Reluplex_Res = Res;
Reluplex_VT = VT;
load P3_exact_star.mat;
exact_star_Res = Res;
exact_star_VT = VT; 
load P3_approx_star.mat;
approx_star_Res = Res; 
approx_star_VT = VT; 
load P3_approx_zono.mat;
approx_zono_Res = Res;
approx_zono_VT = VT;
load P3_abs_dom.mat;
abs_dom_Res = Res; 
...
% print to screen
fprintf('\n===============================================VERIFICATION RESULTS FOR PROPERTY P3====================================================\n');
fprintf('\n=======================================================================================================================================\n');
