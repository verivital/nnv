%% Verify synapse dataset
% SynapseMNIST3D, input size: 28x28x28

% Data
dataset = "../../../../../data/medmnist/mat_files/synapsemnist3d.mat"; % path to data
modelpath = "../../../../../data/medmnist/models/model_synapsemnist3d.mat";

disp("Begin verification of synapse3d");
...
% save results
save("results/verification_synapse_"+adv_attack.Name+"_" +adv_attack.noise_de +"_" +adv_attack.max_pixels + ".mat", "results");
