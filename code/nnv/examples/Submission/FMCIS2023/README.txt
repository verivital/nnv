...
3. File/Folder details:
     a. Appendix : Contains all the images shown in the Appendix Section
          ...
          iii. Local Robustness11   : Fig.6 in paper, example for calculating different robustness measure 
           iv. Network Architecture : Fig.9 in paper, the networks used for the two datasets
     ...
     b. PredictBatterySOCUsingDeepLearningExample : Main folder for running the tests for BSOC dataset
          ...
          iii. reachabilityNoiseForSOC            : function for adding pertubations in the input time series data
           ...
           vi. SOCrobustnessplot                  : plot for robustness measures with increasing noise (Fig.3)
          vii. BSOCplot_SFAI                      : reachability plot for BSOC dataset for a particular time-segment with increasing noise (Fig.2)
     ...
     c. RULEstimationUsingCNNExample              : Main folder for running the tests for TEDS dataset
         ...
         viii. TEDSrobustnessplot           : plot for robustness measures with increasing noise (Fig.6)
