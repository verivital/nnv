function reach_ffnn_large(pix,numT,noise,XTest,YTest,cora,perturbation)
...
save("ffnn_large_nnv_"+string(perturbation)+"_"+string(noise)+".mat",'rob','pred','timeT','pix','numT','noise');
