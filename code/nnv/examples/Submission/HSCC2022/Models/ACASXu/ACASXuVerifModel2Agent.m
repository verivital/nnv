function ds = ACASXuVerifModel2Agent(s,u)
%
% Differential equation describing the dynamics of the physical component
% of the system. 
%
% Here the dynamics corresponds to the combined dynamics of 2 Dubins airplanes
% 
% INPUTS
%
