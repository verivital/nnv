...
% path to benchmarks ( change to whatever local path vnncomp benchmarks are)
...
% We got some penalties here as well... 
% I already looked into this after competition 2023 and it seems fixed
...
% We got penaltis here last year? Let's check that out
% Results (SAT/UNSAT seem to match those of nnenum which had no penalties)
% let's check the counterexamples generated...
...
metaroom_path = vnncomp_path + "metaroom/";
...
for i=1:length(metaroom_instances)
    ...
    run_vnncomp2024_instance("metaroom",onnx,vnnlib,"metaroom_results_" + string(i)+".txt");
end
...
safeNLP_path = "C:/Users/diego/Documents/Research/vnncomp2024/safeNLP/";
...
for i=1:length(safeNLP_instances)
    ...
    run_vnncomp2024_instance("safeNLP",onnx,vnnlib,"safeNLP_results_" + string(i)+".txt");
end
...
cora_path = "C:/Users/diego/Documents/Research/vnncomp2024/cora-vnncomp2024-benchmark/";
...
for i=1:length(cora_instances)
    ...
    run_vnncomp2024_instance("cora",onnx,vnnlib,"cora_results_" + string(i)+".txt");
end
...
cifar100_path = "C:/Users/diego/Documents/Research/vnncomp2024/vnncomp2024-cifar100_benchmark/";
...
for i=1:length(cifar100_instances)
    ...
    run_vnncomp2024_instance("cifar100",onnx,vnnlib,"cifar100_results_" + string(i)+".txt");
end
...
tinyimagenet_path = "C:/Users/diego/Documents/Research/vnncomp2024/vnncomp2024-cifar100_benchmark/";
...
for i=1:length(tinyimagenet_instances)
    ...
    run_vnncomp2024_instance("tinyimagenet",onnx,vnnlib,"tinyimagenet_results_" + string(i)+".txt");
end
