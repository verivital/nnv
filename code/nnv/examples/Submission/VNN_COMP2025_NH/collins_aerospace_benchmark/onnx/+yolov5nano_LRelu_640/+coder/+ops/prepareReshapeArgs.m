...
%   Copyright 2024 The MathWorks, Inc.  
    ...
    ONNXShape__ = yolov5nano_LRelu_640.coder.ops.extractIfDlarray(ONNXShape_);
    allowzero   = coder.const(yolov5nano_LRelu_640.coder.ops.extractIfDlarray(allowzero_));
