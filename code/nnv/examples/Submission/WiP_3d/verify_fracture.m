%% Verify fracture dataset
% VesselMNIST3D, input size: 28x28x28

% Data
dataset = "../../../../../data/medmnist/mat_files/fracturemnist3d.mat"; % path to data
modelpath = "../../../../../data/medmnist/models/model_fracturemnist3d.mat";

disp("Begin verification of fracture3d");
...
% save results
save("results/verification_fracture_"+adv_attack.Name+"_" +adv_attack.noise_de +"_" +adv_attack.max_pixels + ".mat", "results");
