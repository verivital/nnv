...
function [overall_results, disabledTests, i_d] = run_all_tests_inDir(dirname, outputDirname)
    ...
    %offTests = {'test_box_getVertices_c_gen_mexexa64', 'test_box_getVertices_c_gen_rtwk', 'test_FFNNS_reach_star', 'test_NonLinearODE_evaluate', 'test_NonLinearODE_reach_zono', 'test_star_plotBoxes_3D', 'test_PosLin_stepReach', 'test_ReLU_reach_approx', 'test_NonLinearODE_stepReachStar', 'test_LayerS_reach_satlin',  'test_LayerS_reach_poslin', 'test_CNN_parse'};
    ...
    close all ;
    %clearAllExceptVars({t_pause,disabledTests,i_d});
    cd('..');
end
