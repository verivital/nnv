...
function test_supported_categories_reach_import(testCase)
    supported = { 'acasxu', 'cersyve', 'cgan', 'cifar100', ...
        ...
        'edoardo', 'linearize', 'lsnc_relu', 'malbeware', 'metaroom', 'ml4acopf', ...
        'nn4sys', 'relusplitter', 'safenlp', 'sat_relu', 'soundness', ...
        'tinyimagenet', 'tllverify', 'traffic', 'vggnet', 'vit', 'yolo', ...
        ... % 2026 FOLDER-NAME categories: run_all_benchmarks now defaults the
        ... % category to the folder name, so the dispatcher must accept these
        ... % verbatim (they route via contains() to the matching branch).
        'challenging_certified_training_2026', 'relusplitter_2026', ...
        'cgan2026', 'soundnessbench', 'soundnessbench_2026' };
