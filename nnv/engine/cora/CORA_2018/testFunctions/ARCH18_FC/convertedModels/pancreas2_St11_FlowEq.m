function [dx]=pancreas2_St11_FlowEq(t,x,u)

dx(1,1) = 0.50631862*x(7) - 0.0278*x(1) - 2.78695;

dx(2,1) = 0.0488758553275 - 0.0171*x(2);

dx(3,1) = 0.0152*x(2) - 0.0078*x(3);

dx(4,1) = 0.0581*x(5) - 0.0871*x(4) - x(4)*(0.00012207*x(1) + 0.01258413)*(0.0000025097*x(4)^2 - 0.0026*x(4) + 1);

dx(5,1) = 0.0871*x(4) - 0.0628*x(5) - 0.0121*x(9) + x(12)*(0.0000001245*x(11)^2 - 0.00009112*x(11) + 0.02648) + 3.7314;
