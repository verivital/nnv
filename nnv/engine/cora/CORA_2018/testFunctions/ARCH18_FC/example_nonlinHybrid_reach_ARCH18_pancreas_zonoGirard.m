function example_nonlinHybrid_reach_ARCH18_pancreas_zonoGirard()
% example_nonlinHybrid_reach_ARCH18_pancreas_zonoGirard - example of hybrid 
...
%
% Syntax:  
%    example_nonlinHybrid_reach_ARCH18_pancreas_zonoGirard
%
% Inputs:
%    no
%
...
% initial set
int = interval([0;72.429;141.149;162.449;229.824;3.19;5.49;100.249;100.249;120;0], ...
               [0;72.431;141.151;162.451;268.128;3.21;5.51;100.251;100.251;160;0]);
...
options.zonotopeOrder=4; % zonotope order
...
options.loc=3;
options.reductionTechnique='girard';
options.maxError = 150e5*ones(11,1);
options.oldError = zeros(11,1);

% specify hybrid automata
HA = pancreas_hp(); % automatically converted from SpaceEx
...
for i=1:nrOfLoc
    ...
    options.Uloc{i} = zonotope([75 5]); % input deviation for reachability analysis
end
