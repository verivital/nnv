...
rng(3);
inputVol(:, :, 1) = rand(3,3); % channel 1 input matrix
%inputVol(:, :, 2) = rand(5,5); % channel 2 input matrix
%inputVol(:, :, 3) = rand(5,5); % channel 3 input matrix


y = L.evaluate(inputVol);
y2 = L.evaluate2(inputVol);
