function example_linearParam_reach_ARCH17_platoon()
...
%options.zonotopeOrder=2000; %zonotope order; helped a little
%options.zonotopeOrder=3200; %zonotope order; helped a little
