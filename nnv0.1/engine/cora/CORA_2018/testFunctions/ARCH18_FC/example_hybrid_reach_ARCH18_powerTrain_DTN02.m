function completed = example_hybrid_reach_ARCH18_powerTrain_DTN02()
% example_hybrid_reach_ARCH18_powerTrain_DTN02 - example for hybrid 
% dynamics from the ARCH18 friendly competition (Test case DTN02)
%
