function example_linear_reach_ARCH18_building_constInput()
% example_linear_reach_ARCH18_building - example of linear reachability 
% analysis from the ARCH18 friendly competition (building example with 
% constant inputs)
%
% Syntax:  
...
R0 = interval([0.0002*ones(10,1); -0.0001; zeros(37,1); 0.8], [0.00025*ones(10,1); 0.0001; zeros(37,1); 1]);
...
options.U=zonotope([options.uTrans,0]); %input for reachability analysis

buildingSys=linearSys('buildingSys',A_,B_); %initialize system
