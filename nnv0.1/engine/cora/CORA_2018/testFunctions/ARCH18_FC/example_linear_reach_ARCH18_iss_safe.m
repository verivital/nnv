function [completed] = example_linear_reach_ARCH18_iss_safe(varargin)
% example_linear_reach_ARCH18_iss_safe - example for linear dynamics. It
%       is checked if the safe specification is satisfied
%
% Syntax:  
